...
public class CadGrupoSubGrupoController extends CadastroFormPadrao {

	private final static Logger LOGGER = Logger.getLogger(CadGrupoSubGrupoController.class.getName());
	...
	private CadGrupoSubGrupoController setImagemPadrao() {
		imagens = null;
		imgProduto.setImage(ImagemPadrao);
		return this;
	}

	private CadGrupoSubGrupoController desabilitaBotoes() {
	...
	private CadGrupoSubGrupoController habilitaBotoes() {
	...
	@Override
	public CadGrupoSubGrupoController atualizaEntidade() {
		if (produto == null)
			produto = new Produto();
	...
	private CadGrupoSubGrupoController atualizaTela(Produto produto) {
		limpaCampos();
	...
	private CadGrupoSubGrupoController setSqlFrame() {
	...
	private CadGrupoSubGrupoController configuraExitId() {
