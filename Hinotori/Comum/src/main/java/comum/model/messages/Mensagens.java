...
public class Mensagens {
	...
	public final static String USR_LOGIN_EXITENTE = "Erro ao salvar o usuário, login já utilizado";
	public final static String USR_ERRO_AO_VALIDAR_LOGIN = "Não foi possível validar o login.";
	public final static String USR_ERRO_SENHA = "Não foi possível decodificar a senha.";
