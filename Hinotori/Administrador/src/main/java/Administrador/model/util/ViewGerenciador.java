package administrador.model.util;
...
public class ViewGerenciador {
	...
	public static void carregaCss() {
		stylesheets.addAll(ViewGerenciador.class.getResource("/administrador/resources/css/Paleta_Cores.css").toExternalForm(),
				ViewGerenciador.class.getResource("/administrador/resources/css/White_Cadastros.css").toExternalForm(),
				ViewGerenciador.class.getResource("/administrador/resources/css/White_Dashboard.css").toExternalForm(),
				ViewGerenciador.class.getResource("/administrador/resources/css/White_Dashboard_Botoes.css").toExternalForm(),
				ViewGerenciador.class.getResource("/administrador/resources/css/White_Dashboard_Graficos.css").toExternalForm(),
				ViewGerenciador.class.getResource("/administrador/resources/css/White_Frame.css").toExternalForm());
	}
